...
<head>
    ...
    <link href="{{asset('plantilla/css/tacna.css')}}" rel="stylesheet">
                                    ...
                                    <form class="user" method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="email" type="email" class="form-control 
                                                @error('email') is-invalid @enderror form-control-user" name="email" 
                                        ...
                                        <div class="form-group">
                                            <input id="password" type="password" class="form-control 
                                                @error('password') is-invalid @enderror form-control-user" name="password" 
                                        ...
                                        <button type="submit" class="btn btn-user btn-block btn-tacna">
                                            {{ __('Login') }}
                                        </button>
                                    </form>
                                    <hr>
